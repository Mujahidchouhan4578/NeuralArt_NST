...
from tqdm import tqdm # common library to track loops
from torchvision.utils import save_image
def parse_arguments():
    parser=argparse.ArgumentParser()

    parser.add_argument('--content_dir',type=str,default='E:/newcreation/NST/content_data',help='Location of content dataset')
    parser.add_argument('--style_dir',type=str,default='E:/newcreation/NST/style_data',help='Location of style dataset')
    parser.add_argument('--vgg',type=str,default='E:/newcreation/NST/vgg_normalised.pth',help='Location of pre-trained vgg')
    ...
    return parser.parse_args() # all argument return
...
def main():
    ...
    style_dataloader=DataLoader(style_dataset,batch_size=args.batch_size,shuffle=False,pin_memory=True,drop_last=True)
       
    print('Number of batches in content dataset is:',len(content_dataloader))
    print('Number of batches in style dataset is:',len(style_dataloader))
    ...
    for epoch in range(args.epochs):
        ...
        for content_batch,style_batch in progress_bar:
            ...
            # testing encoded c_feats and s_feats
            # print("this is len of c feats",len(c_feats))
            # print("this is len of s feats:",len(s_feats))
