...
# decoder.load_state_dict(torch.load('E:/newcreation/NST/experiment/experiment1/decoder_final.pth'))

decoder.load_state_dict(
    torch.load(
        'E:/newcreation/NST/experiment/experiment1/decoder_final.pth',
